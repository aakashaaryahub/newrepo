...
import '../styles/CollateralPage.css'; // For custom styles
        ...
        <div className="collateral-page">
            ...
            <TableContainer component={Paper} sx={{ marginTop: 3 }}>
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            <TableCell><strong>Collateral Type</strong></TableCell>
                    ...
                    <TableBody>
                        {collaterals.length === 0 ? (
                            <TableRow>
                                <TableCell colSpan={3} align="center">No collaterals added yet.</TableCell>
                            </TableRow>
                        ) : (
