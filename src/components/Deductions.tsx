...
const Deductions: React.FC = () => {
    const [Deductionss, setGuarantors] = useState<any[]>([]);
    ...
    return (
        <IonContent className="guarantor-page">
            ...
            <div className="content-box">
                ...
                {/* Table to display the list of deductions */}
                <table style={{ width: '100%', marginTop: '20px', borderCollapse: 'collapse' }}>
                    ...
                    <tbody>
                        {Deductionss.length === 0 ? (
                            <tr>
                                <td colSpan={3} style={{ textAlign: 'center' }}>No deductions added yet.</td>
                            </tr>
                        ) : (
                            Deductionss.map((guarantor, index) => (
                                <tr key={index}>
                ...
                {/* IonAlert for adding a new deduction */}
                <IonAlert
                    isOpen={showAlert}
